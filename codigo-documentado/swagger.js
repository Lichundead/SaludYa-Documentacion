...
const options = {
  definition: {
    ...
    info: {
      ...
      contact: {
        name: "Equipo SaludYa",
        url: "https://github.com/Alejandro-OrtizG/saludYaCICD",
      },
      license: { name: "MIT" },
    },
    servers: [
      { url: "http://localhost:3001", description: "Servidor local de desarrollo" },
      { url: "https://saludyacicd.onrender.com", description: "Servidor de producción (Render)" },
    ],
    components: {
      schemas: {
        ...
        Usuario: {
          ...
          properties: {
            ...
            email: { type: "string", format: "email", example: "demo@saludya.com" },
        ...
        Cita: {
          ...
          properties: {
            id: { type: "integer", example: 1 },
            paciente_email: { type: "string", format: "email", example: "demo@saludya.com" },
